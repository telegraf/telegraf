...
class Telegraf {
  ...
  handleUpdate (update, webHookResponse) {
    ...
    var ctx
    if (webHookResponse) {
      ctx = new TelegrafContext(this.token, update, {telegram: Object.assign({webHookResponse: webHookResponse}, this.options.telegram)})
    } else {
      ctx = new TelegrafContext(this.token, update, this.options)
    }
