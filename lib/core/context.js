const updateTypes = [ 'message', 'edited_message', 'callback_query', 'inline_query', 'chosen_inline_result' ]
const messageSubTypes = [
  ...
  'migrate_from_chat_id', 'pinned_message', 'game'
]
...
class TelegrafContext {
  ...
  get updateType () {
    return updateTypes.find((key) => this.update[key])
  }

  get updateSubType () {
    return this.update.message && messageSubTypes.find((key) => this.update.message[key])
  }
