...
export class Context {
  ...
  get editedMessage() { return this.update?.edited_message }
  get inlineQuery() { return this.update?.inline_query }
  get shippingQuery() { return this.update?.shipping_query }
  get preCheckoutQuery() { return this.update?.pre_checkout_query }
  get chosenInlineResult() { return this.update?.chosen_inline_result }
  get channelPost() { return this.update?.channel_post }
  get editedChannelPost() { return this.update?.edited_channel_post }
  ...
  get passportData() { return this?.message?.passport_data }
