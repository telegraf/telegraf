...
class Telegraf extends Telegram {
  ...
  handleUpdate (update, webHookResponse) {
    ...
    const ctx = new TelegrafContext(this, update)

    // const proxy = this
    // if (this.options.webHookAnswer && webHookResponse) {
    //   ctx.webHookResponse = webHookResponse
    //   const self = this
    //   // 🐵-patching
    //   proxy = {
