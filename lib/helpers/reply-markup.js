...
class ReplyMarkup {
  ...
  static removeKeyboard (value) {
    return new ReplyMarkup().removeKeyboard(value)
  }
...
ReplyMarkup.hideKeyboard = util.deprecate(ReplyMarkup.removeKeyboard, 'telegraf: `hideKeyboard` is deprecated. Use `removeKeyboard` instead.')
ReplyMarkup.prototype.hideKeyboard = util.deprecate(ReplyMarkup.prototype.removeKeyboard, 'telegraf: `hideKeyboard` is deprecated. Use `removeKeyboard` instead.')
