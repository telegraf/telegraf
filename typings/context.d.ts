...
export declare class TelegrafContext {
  ...
  /**
   * Use this method to send a dice, which will have a random value from 1 to [5-6]. On success, the sent Message is returned. (Yes, we're aware of the “proper” singular of die. But it's awkward, and we decided to help it change. One dice at a time!)
