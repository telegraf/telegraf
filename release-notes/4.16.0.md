...
What does this mean? If you're using Telegraf v4, you can continue to use it as you have been. The following changes will occur until February 2025:

- Bug fixes and security updates will continue to be released for Telegraf v4.
- The existing documentation for Telegraf v4 will remain available.
- New API updates will be implemented only to ensure compatibility with the latest Telegram Bot API. No new convenience features will be added to Telegraf v4.

In the coming weeks, we plan to release Telegraf v5. Telegraf v5 will feature a revamped API, new functionalities, numerous convenient helpers, an improved approach to handling updates, and enhanced documentation. If you have closely followed the development of v4 and have stayed updated with deprecation notices, the transition to v5 will be seamless for you. For those still using v4, we will provide a migration guide to assist you in upgrading to v5. Stay tuned for more information on the release of v5!

### Go follow the releases channel on Telegram: [t.me/Telegraf_JS](https://t.me/Telegraf_JS).
