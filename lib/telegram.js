...
class Telegram extends ApiClient {
  ...
  sendInvoice (chatId, invoice) {
    return this.callApi('sendInvoice', Object.assign({ chat_id: chatId }, invoice))
  }
  ...
  sendVideoNote (chatId, video, length, extra) {
    return this.callApi('sendVideoNote', Object.assign({ chat_id: chatId, video_note: video, length: length }, extra))
  }
