...
class Telegram extends TelegramClient {
  ...
  setWebHook (url, cert) {
    return this.callApi('setWebHook', { url: url, certificate: cert })
  }
  ...
  forwardMessage (chatId, fromChatId, messageId, extra) {
    return this.callApi('forwardMessage', Object.assign({ chat_id: chatId, from_chat_id: fromChatId, message_id: messageId }, extra))
  }
  ...
  kickChatMember (chatId, userId) {
    return this.callApi('kickChatMember', { chat_id: chatId, userId: userId })
  }
  ...
  unbanChatMember (chatId, userId) {
    return this.callApi('unbanChatMember', { chat_id: chatId, userId: userId })
  }

  answerCallbackQuery (callbackQueryId, text, showAlert) {
    return this.callApi('answerCallbackQuery', { callback_query_id: callbackQueryId, text: text, show_alert: showAlert })
  }
  ...
  sendCopy (chatId, message, extra) {
    ...
    if (!type) {
      throw new TelegramError('Unsupported message type')
    }
