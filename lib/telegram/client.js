...
class Telegram {
  ...
  callApi (method, options) {
    ...
    if (this.webHookResponse && !this.webHookResponse.finished && !isMultipartRequest && !webHookAnswerBlacklist.includes(method)) {
      debug('▷ webhook', method)
      options.method = method
      if (!this.webHookResponse.headersSent) {
        this.webHookResponse.setHeader('Content-Type', 'application/json')
      }
      this.webHookResponse.end(JSON.stringify(options))
