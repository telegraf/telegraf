...
class Telegraf extends Composer {
  ...
  handleUpdate (update, webHookResponse) {
    ...
    const telegramOptions = webHookResponse
      ? Object.assign({webHookResponse: webHookResponse}, this.options.telegram)
      : this.options.telegram
    const ctx = new Context(this.token, update, this.options, telegramOptions)
