"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.ApiClient = exports.defaultOptions = exports.defaultExtensions = exports.webhookBlacklist = void 0;var _debug = _interopRequireDefault(require("debug"));
...
var _multipartStream = require("./multipart-stream");function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
'getWebhookInfo'];exports.webhookBlacklist = webhookBlacklist;
...
const defaultExtensions = {
  ...
  video: 'mp4',
  video_note: 'mp4',
  voice: 'ogg' };exports.defaultExtensions = defaultExtensions;
...
function buildFormDataPayload(options) {
  ...
  return (0, _fluture.tryP)(() => Promise.all(tasks)).
  map(() => ({
    method: 'POST',
...
{
  return (0, _fluture.tryP)(() => (0, _nodeFetch.default)(`${root}/bot${token}/${method}`).
  then(res => res.text()).
  catch(error => {
    throw new _telegramError.TelegramError(error.text, { method, extra });
  }).
  then(text => {
    try {
      ...
      throw new _telegramError.TelegramError(error, { method, extra });
    }
  }).
...
const defaultOptions = {
  ...
  agent: new _https.default.Agent({
    keepAlive: true,
    keepAliveMsecs: 10000 }) };exports.defaultOptions = defaultOptions;
...
class ApiClient {
  ...
  callApi(method, extra)
  {
    ...
    !webhookBlacklist.includes(method)) {
      ...
      return (0, _fluture.resolve)({ webhook: true });
    }
    ...
    chainRej(err => (0, _fluture.reject)(new _telegramError.TelegramError(err.message, { method, extra })));
