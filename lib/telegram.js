...
class Telegram extends ApiClient {
  ...
  sendContact (chatId, phoneNumber, firstName, lastName, extra) {
    return this.callApi('sendContact', Object.assign({ chat_id: chatId, phone_number: phoneNumber, first_name: firstName, last_name: lastName }, extra))
  }
